...
namespace sdkbox {
    ...
    public:
         ...
         *
         * @param value  YES to show errors in debug logs,  NO to omit errors in debug logs.
         *
         * @related function
         ...
         * @note This method must be called prior to invoking #startSession:.
         *
         * @param value  YES to enable collection of crash reports.
         *
         * @related function
        ...
        /*!
         * @brief Start a Flurry session for the project denoted by  apiKey.
         *
        ...
        /*!
         * @brief Adds an SDK origin specified by  originName and  originVersion.
         *
        ...
        /*!
         * @brief Adds a custom parameterized origin specified by  originName with  originVersion and  parameters.
         *
        ...
        /*!
         * @brief Records a custom event specified by  eventName.
         *
        ...
        /*!
         * @brief Records a custom parameterized event specified by  eventName with  parameters.
         *
        ...
        /*!
         * @brief Records a timed event specified by  eventName.
         *
        ...
        /*!
         * @brief Records a custom parameterized timed event specified by  eventName with  parameters.
         *
        ...
        /*!
         * @brief Ends a timed event specified by  eventName and optionally updates parameters with  parameters.
         *
